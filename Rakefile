...
ssh_user       = "deploy@codrtv.do.codehire.io"
ssh_port       = "22"
document_root  = "/var/www/blog.codehire.com"
rsync_delete   = true
rsync_args     = "--verbose"  # Any extra arguments to pass to rsync
...
public_dir      = "public/runtime"    # compiled site directory
